...
export const MyExperience =({user}:any)=>{
    ...
    const handleCreateExperience =()=>{
        if(pictureInput !== null && titleInput !== null && companyInput !== null && locationInput !== null) {
            createNewExperience({
                ...
                const userRef = ref(storage, `${user.username}/experience/${e.data.insert_UserExperience_one.experience_id}`)
    ...
    return  <BoxInnerTemplates>
                ...
                <div className="my-experience-container">
                    ...
                    <div className="my-experience-card-outer-container">
                        {
                            user.UserExperiences.map((exp:any, i:any)=>
                                <div className="" key={i}>
